...
const Students = () => {
  ...
  const [formData, setFormData] = useState({
    studentId: '', firstName: '', lastName: '', gender: 'Male', className: '', parentPhone: '', address: ''
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({ studentId: '', firstName: '', lastName: '', gender: 'Male', className: '', parentPhone: '', address: '' });
      fetchStudents();
    ...
    <div className="container mx-auto p-4 space-y-8">
      <div className="card">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <input type="text" placeholder="Student ID" className="border p-2 rounded" required
          ...
          <input type="text" placeholder="Parent Phone" className="border p-2 rounded" required
      ...
      <div className="card">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            ...
            <tbody>
              {students.map((s) => (
                <tr key={s._id} className="table-row-striped">
